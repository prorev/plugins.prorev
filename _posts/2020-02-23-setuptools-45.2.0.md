...
- `setuptools-45.2.0/bootstrap.py` 
...
- `setuptools-45.2.0/easy_install.py` 
...
- `setuptools-45.2.0/pkg_resources/py31compat.py` 
...
- `setuptools-45.2.0/pkg_resources/py2_warn.py` 
...
- `setuptools-45.2.0/pkg_resources/__init__.py` 
...
- `setuptools-45.2.0/pkg_resources/extern/__init__.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/pyparsing.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/six.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/__init__.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/appdirs.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/version.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/_structures.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/utils.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/markers.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/__about__.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/__init__.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/_compat.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/specifiers.py` 
...
- `setuptools-45.2.0/pkg_resources/_vendor/packaging/requirements.py` 
...
- `setuptools-45.2.0/pkg_resources/tests/test_markers.py` 
...
- `setuptools-45.2.0/pkg_resources/tests/test_working_set.py` 
...
- `setuptools-45.2.0/pkg_resources/tests/test_resources.py` 
...
- `setuptools-45.2.0/pkg_resources/tests/test_pkg_resources.py` 
...
- `setuptools-45.2.0/pkg_resources/tests/test_find_distributions.py` 
...
- `setuptools-45.2.0/pkg_resources/tests/__init__.py` 
...
- `setuptools-45.2.0/pkg_resources/tests/data/my-test-package-source/setup.py` 
...
- `setuptools-45.2.0/docs/conf.py` 
...
- `setuptools-45.2.0/setuptools/py31compat.py` 
...
- `setuptools-45.2.0/setuptools/site-patch.py` 
...
- `setuptools-45.2.0/setuptools/launch.py` 
...
- `setuptools-45.2.0/setuptools/version.py` 
...
- `setuptools-45.2.0/setuptools/namespaces.py` 
...
- `setuptools-45.2.0/setuptools/archive_util.py` 
...
- `setuptools-45.2.0/setuptools/msvc.py` 
...
- `setuptools-45.2.0/setuptools/wheel.py` 
...
- `setuptools-45.2.0/setuptools/py33compat.py` 
...
- `setuptools-45.2.0/setuptools/sandbox.py` 
...
- `setuptools-45.2.0/setuptools/glob.py` 
...
- `setuptools-45.2.0/setuptools/dist.py` 
...
- `setuptools-45.2.0/setuptools/py34compat.py` 
...
- `setuptools-45.2.0/setuptools/ssl_support.py` 
...
- `setuptools-45.2.0/setuptools/extension.py` 
...
- `setuptools-45.2.0/setuptools/installer.py` 
...
- `setuptools-45.2.0/setuptools/lib2to3_ex.py` 
...
- `setuptools-45.2.0/setuptools/depends.py` 
...
- `setuptools-45.2.0/setuptools/dep_util.py` 
...
- `setuptools-45.2.0/setuptools/py27compat.py` 
...
- `setuptools-45.2.0/setuptools/windows_support.py` 
...
- `setuptools-45.2.0/setuptools/monkey.py` 
...
- `setuptools-45.2.0/setuptools/build_meta.py` 
...
- `setuptools-45.2.0/setuptools/config.py` 
...
- `setuptools-45.2.0/setuptools/_deprecation_warning.py` 
...
- `setuptools-45.2.0/setuptools/__init__.py` 
...
- `setuptools-45.2.0/setuptools/unicode_utils.py` 
...
- `setuptools-45.2.0/setuptools/errors.py` 
...
- `setuptools-45.2.0/setuptools/_imp.py` 
...
- `setuptools-45.2.0/setuptools/extern/__init__.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/pyparsing.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/six.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/ordered_set.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/__init__.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/version.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/_structures.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/tags.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/utils.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/markers.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/__about__.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/__init__.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/_compat.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/specifiers.py` 
...
- `setuptools-45.2.0/setuptools/_vendor/packaging/requirements.py` 
...
- `setuptools-45.2.0/setuptools/command/upload_docs.py` 
...
- `setuptools-45.2.0/setuptools/command/register.py` 
...
- `setuptools-45.2.0/setuptools/command/install_scripts.py` 
...
- `setuptools-45.2.0/setuptools/command/sdist.py` 
...
- `setuptools-45.2.0/setuptools/command/bdist_rpm.py` 
...
- `setuptools-45.2.0/setuptools/command/upload.py` 
...
- `setuptools-45.2.0/setuptools/command/rotate.py` 
...
- `setuptools-45.2.0/setuptools/command/alias.py` 
...
- `setuptools-45.2.0/setuptools/command/build_py.py` 
...
- `setuptools-45.2.0/setuptools/command/develop.py` 
...
- `setuptools-45.2.0/setuptools/command/easy_install.py` 
...
- `setuptools-45.2.0/setuptools/command/build_ext.py` 
...
- `setuptools-45.2.0/setuptools/command/install_lib.py` 
...
- `setuptools-45.2.0/setuptools/command/install_egg_info.py` 
...
- `setuptools-45.2.0/setuptools/command/test.py` 
...
- `setuptools-45.2.0/setuptools/command/install.py` 
...
- `setuptools-45.2.0/setuptools/command/bdist_wininst.py` 
...
- `setuptools-45.2.0/setuptools/command/bdist_egg.py` 
...
- `setuptools-45.2.0/setuptools/command/setopt.py` 
...
- `setuptools-45.2.0/setuptools/command/build_clib.py` 
...
- `setuptools-45.2.0/setuptools/command/py36compat.py` 
...
- `setuptools-45.2.0/setuptools/command/__init__.py` 
...
- `setuptools-45.2.0/setuptools/command/egg_info.py` 
...
- `setuptools-45.2.0/setuptools/command/saveopts.py` 
...
- `setuptools-45.2.0/setuptools/command/dist_info.py` 
...
- `setuptools-45.2.0/setuptools/tests/fixtures.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_build_ext.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_windows_wrappers.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_unicode_utils.py` 
...
- `setuptools-45.2.0/setuptools/tests/textwrap.py` 
...
- `setuptools-45.2.0/setuptools/tests/namespaces.py` 
...
- `setuptools-45.2.0/setuptools/tests/text.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_dist_info.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_manifest.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_sdist.py` 
...
- `setuptools-45.2.0/setuptools/tests/mod_with_constant.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_namespaces.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_install_scripts.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_build_clib.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_easy_install.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_config.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_build_py.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_register.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_setuptools.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_packageindex.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_msvc.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_dist.py` 
...
- `setuptools-45.2.0/setuptools/tests/script-with-bom.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_setopt.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_depends.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_virtualenv.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_build_meta.py` 
...
- `setuptools-45.2.0/setuptools/tests/environment.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_wheel.py` 
...
- `setuptools-45.2.0/setuptools/tests/files.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_integration.py` 
...
- `setuptools-45.2.0/setuptools/tests/contexts.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_find_packages.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_archive_util.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_glob.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_test.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_sandbox.py` 
...
- `setuptools-45.2.0/setuptools/tests/server.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_upload_docs.py` 
...
- `setuptools-45.2.0/setuptools/tests/__init__.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_dep_util.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_egg_info.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_upload.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_develop.py` 
...
- `setuptools-45.2.0/setuptools/tests/test_bdist_egg.py` 
